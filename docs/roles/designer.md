...
| [`om-ux-setup`](../skills/om-ux-setup.md) | Make the design system executable | `/om-ux-setup` | the repo's design contract in `.houserules/` — tokens, components, screen archetypes, team rules |
